...
import org.monarchinitiative.threes.ingest.ThreesDataBuilder;
...
public class RunIngestCommand extends IngestCommand {
    ...
    public void run(Namespace args) throws Exception {
        ...
        // 3 - build database
        ThreesDataBuilder.buildDatabase(genomeBuildDir, genomeUrl, Path.of(ingestProperties.getJannovarTranscriptDbDir()),
