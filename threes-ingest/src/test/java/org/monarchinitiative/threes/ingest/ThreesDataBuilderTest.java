...
class ThreesDataBuilderTest {
    ...
    void downloadReferenceGenome() throws ThreeSException {
        ...
        ThreesDataBuilder.downloadReferenceGenome(FASTA_URL, buildDir, VERSIONED_ASSEMBLY, true);
    ...
    void ingestTranscripts() throws Exception {
        ...
        // act
        ThreesDataBuilder.ingestTranscripts(dataSource, accessor.getReferenceDictionary(), accessor, transcriptModels, splicingInformationContentCalculator);
