...
class SparseSplicingAnnotatorTest {
    ...
    void variantInFirstDonor() {
        ...
        final SplicingLocationData ld = SplicingLocationData.builder()
        ...
        ImmutableMap<String, Double> scoresMap = data.getScoresMap();
        assertThat(scoresMap.size(), is(2));
        assertThat(scoresMap, hasEntry(ScoringStrategy.CANONICAL_DONOR.name(), 0.5));
        assertThat(scoresMap, hasEntry(ScoringStrategy.CRYPTIC_DONOR_IN_CANONICAL_POSITION.name(), 0.8));
    }
    ...
    void variantInFirstAcceptor() {
        ...
        ImmutableMap<String, Double> scoresMap = data.getScoresMap();
        assertThat(scoresMap.size(), is(2));
        assertThat(scoresMap, hasEntry(ScoringStrategy.CANONICAL_ACCEPTOR.name(), 0.9));
        assertThat(scoresMap, hasEntry(ScoringStrategy.CRYPTIC_ACCEPTOR_IN_CANONICAL_POSITION.name(), 0.6));
    }
    ...
    void variantInTheIntron() {
        ...
        ImmutableMap<String, Double> scoresMap = data.getScoresMap();
        assertThat(scoresMap.size(), is(2));
        assertThat(scoresMap, hasEntry(ScoringStrategy.CRYPTIC_DONOR.name(), 0.7));
        assertThat(scoresMap, hasEntry(ScoringStrategy.CRYPTIC_ACCEPTOR.name(), 0.5));
    }
