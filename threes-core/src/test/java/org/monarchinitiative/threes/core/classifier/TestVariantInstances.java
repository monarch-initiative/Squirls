...
/**
 * Variant data being used for integration test of {@link OverlordClassifier} and its parts.
 */
public class TestVariantInstances {
     ...
     */
    public static FeatureData pathogenicDonor() {
     ...
     */
    public static FeatureData donorCryptic() {
     ...
     */
    public static FeatureData pathogenicAcceptor() {
     ...
     */
    public static FeatureData acceptorCryptic() {
        return makeFeature(-108, 0., -17.6901254762917,
                -15., 0.729759824433353, 0.,
                .922999978065491, 0.862883, 1.4614);
    }

    private static FeatureData makeFeature(double donorOffset, double canonicalDonor, double crypticDonor,
