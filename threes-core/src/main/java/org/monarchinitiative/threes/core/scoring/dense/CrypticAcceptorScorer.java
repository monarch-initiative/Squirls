...
class CrypticAcceptorScorer extends BaseScorer {
    ...
    CrypticAcceptorScorer(SplicingInformationContentCalculator calculator, AlleleGenerator generator) {
