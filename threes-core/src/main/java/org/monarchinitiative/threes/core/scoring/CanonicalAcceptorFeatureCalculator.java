...
class CanonicalAcceptorFeatureCalculator extends BaseFeatureCalculator {

    private static final Logger LOGGER = LoggerFactory.getLogger(CanonicalAcceptorFeatureCalculator.class);


    CanonicalAcceptorFeatureCalculator(SplicingInformationContentCalculator annotator, AlleleGenerator generator) {
