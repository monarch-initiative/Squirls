...
public class BigWigSection {
    ...
    private final boolean isLowToHigh;       // byte order is low to high if true; else high to low
    ...
    private final RPTreeLeafNodeItem leafHitItem;    // leaf item defines chromosome region and file data location
    ...
    private final BigWigSectionHeader wigSectionHeader;  // wig section header
