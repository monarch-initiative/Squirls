...
public class BPTreeChildNodeItem implements BPTreeNodeItem {
    ...
    private final long itemIndex;     // item index in child node list
    ...
    private final String chromKey;   // mChromosome/contig name; of keysize chars

    private final BPTreeNode childNode;  // child node
