...
public class RPTree {
    ...
    // R+ tree bounds
    private final RPChromosomeRegion chromosomeBounds;  // R+ tree's bounding chromosome region

    // R+ tree nodal variables
    private final int order;         // R+ tree order: maximum number of leaves per node
