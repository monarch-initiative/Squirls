...
public class DenseSplicingAnnotatorTest {
    ...
    public void secondExonAcceptor() {
        ...
        assertThat(features.getFeature("canonical_acceptor", Double.class), is(closeTo(9.9600, EPSILON)));
        assertThat(features.getFeature("canonical_donor", Double.class), is(closeTo(0., EPSILON)));
        assertThat(features.getFeature("cryptic_acceptor", Double.class), is(closeTo(6.7992, EPSILON)));
        assertThat(features.getFeature("cryptic_donor", Double.class), is(closeTo(4.7136, EPSILON)));
    }
    ...
    public void thirdExonAcceptor() {
        ...
        assertThat(features.getFeature("canonical_acceptor", Double.class), is(closeTo(0., EPSILON)));
        assertThat(features.getFeature("cryptic_acceptor", Double.class), is(closeTo(-8.9753, EPSILON)));
    }
