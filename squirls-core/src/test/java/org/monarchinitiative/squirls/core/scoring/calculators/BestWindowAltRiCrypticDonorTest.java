...
public class BestWindowAltRiCrypticDonorTest extends CalculatorTestBase {
    ...
    public void snpInDonor() {
        Variant variant = Variant.of(contig, "", Strand.POSITIVE, CoordinateSystem.zeroBased(), 1200, "g", "a");
        assertThat(scorer.score(variant, txOnPositiveStrand, sequence), is(closeTo(-2.3987, EPSILON)));
    }
