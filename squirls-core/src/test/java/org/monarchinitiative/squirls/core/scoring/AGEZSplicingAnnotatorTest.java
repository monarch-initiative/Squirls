...
public class AGEZSplicingAnnotatorTest extends BaseSplicingAnnotatorTest {
    ...
    public void annotate(int pos, String ref, String alt,
        ...
        assertThat(features.getFeature("creates_ag_in_agez"), is(closeTo(createsAgInAgez, EPSILON)));
        assertThat(features.getFeature("ppt_is_truncated"), is(closeTo(pptIsTruncated, EPSILON)));
        assertThat(features.getFeature("yag_at_acceptor_minus_three"), is(closeTo(purineAtMinusThree, EPSILON)));
        assertThat(features.getFeature("creates_yag_in_agez"), is(closeTo(createsYagInAgez, EPSILON)));
    }

    @Test
    public void allFeaturesAreCalculated() {
        GenomicVariant variant = GenomicVariant.of(contig, "", Strand.POSITIVE, CoordinateSystem.zeroBased(), 1389, "c", "cag");
