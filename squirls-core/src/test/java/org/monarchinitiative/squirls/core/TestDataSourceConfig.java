...
public class TestDataSourceConfig {
    ...
    @Bean
    public TranscriptModelLocator splicingTranscriptLocator(SplicingParameters splicingParameters) {
        return new TranscriptModelLocatorNaive(splicingParameters);
    }
