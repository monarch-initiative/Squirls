...
public class CanonicalDonorFeatureCalculator extends BaseFeatureCalculator {

    private static final Logger LOGGER = LoggerFactory.getLogger(CanonicalDonorFeatureCalculator.class);

    public CanonicalDonorFeatureCalculator(SplicingInformationContentCalculator annotator, AlleleGenerator generator) {
