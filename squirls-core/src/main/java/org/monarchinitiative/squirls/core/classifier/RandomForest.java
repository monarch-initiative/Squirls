...
public class RandomForest<T extends SquirlsFeatures> extends AbstractBinaryClassifier<T> {
    ...
    public static <A extends SquirlsFeatures> Builder<A> builder() {
        return new Builder<>();
    }
    ...
    public static class Builder<A extends SquirlsFeatures> extends AbstractBinaryClassifier.Builder<Builder<A>> {
