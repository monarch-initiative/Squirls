...
public class CrypticAcceptorFeatureCalculator extends BaseFeatureCalculator {
    ...
    public CrypticAcceptorFeatureCalculator(SplicingInformationContentCalculator calculator, AlleleGenerator generator) {
