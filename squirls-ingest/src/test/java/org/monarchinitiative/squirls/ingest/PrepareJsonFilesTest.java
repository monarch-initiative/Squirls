...
/**
 * The test prepares JSON files located in <code>autoconfigure</code> and <code>bootstrap</code> test resource folders.
 * Provide paths to GTF, and run both tests. Then, move the generated files into the target locations manually
 */
@Disabled // to run manually
public class PrepareJsonFilesTest {

    private static final GenomicAssembly ASSEMBLY = GenomicAssemblies.GRCh37p13();

    private static final Set<String> SYMBOLS = Set.of("GCK", "HNF4A", "FBN1");

    // Provide the path to the hg19 Gencode GTF file
