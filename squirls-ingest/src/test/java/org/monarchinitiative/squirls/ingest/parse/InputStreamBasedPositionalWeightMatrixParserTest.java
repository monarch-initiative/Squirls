...
public class InputStreamBasedPositionalWeightMatrixParserTest {
    ...
    public void parseAllTest() throws Exception {
        ...
        assertThat(splicingPwmData.getDonor(), equalTo(PojosForTesting.makeDonorMatrix()));
        assertThat(splicingPwmData.getAcceptor(), equalTo(PojosForTesting.makeAcceptorMatrix()));
        assertThat(splicingPwmData.getParameters(), equalTo(PojosForTesting.makeSplicingParameters()));
    }
