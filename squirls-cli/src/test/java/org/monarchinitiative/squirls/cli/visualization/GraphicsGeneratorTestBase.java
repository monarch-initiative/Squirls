...
public class GraphicsGeneratorTestBase {
    ...
    protected static VisualizableVariantAllele toVisualizableAllele(WritableSplicingAllele writableSplicingAllele) {
        return new SimpleVisualizableVariantAllele(writableSplicingAllele.variant(), writableSplicingAllele.variantAnnotations(), writableSplicingAllele.squirlsResult());
    }
