...
class PwmIngestDaoTest {
    ...
    void insertDoubleMatrix() throws Exception {
        ...
        String pwmDataSql = "select PWM_NAME, ROW_IDX, COL_IDX, CELL_VALUE from SQUIRLS.PWM_DATA";
        String pwmMetadataSql = "select PWM_NAME, PWM_KEY, PWM_VALUE from SQUIRLS.PWM_METADATA";
