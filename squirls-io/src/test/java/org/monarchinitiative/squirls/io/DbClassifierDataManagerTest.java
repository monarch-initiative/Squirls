...
public class DbClassifierDataManagerTest {
    ...
    @Test
    @Sql(scripts = "create_classifier_table.sql", statements = "insert into SPLICING.CLASSIFIER(version, data) values ('v0_4_1', '000F10FF')")
    public void readClassifier() throws Exception {
        final byte[] bytes = manager.readClassifierBytes(SquirlsClassifierVersion.v0_4_1);
    ...
    public void getAllClassifiers() {
        final Collection<SquirlsClassifierVersion> clfs = manager.getAvailableClassifiers();
