...
public class PartialPredictionDefault implements PartialPrediction {
    ...
    private PartialPredictionDefault(String name, double pathoProba, double threshold) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.getPathoProba(), pathoProba) == 0 &&
                Double.compare(that.getThreshold(), threshold) == 0 &&
