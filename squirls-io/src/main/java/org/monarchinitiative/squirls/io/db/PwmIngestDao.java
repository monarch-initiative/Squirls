...
public class PwmIngestDao {
    ...
    public int insertDoubleMatrix(DoubleMatrix matrix, String name, int exon, int intron) {
        int nRows = 0;
        String pwmDataSql = "INSERT INTO SQUIRLS.PWM_DATA(PWM_NAME, ROW_IDX, COL_IDX, CELL_VALUE) VALUES (?, ?, ?, ?)";
        String pwmMetadataSql = "INSERT INTO SQUIRLS.PWM_METADATA(PWM_NAME, PWM_KEY, PWM_VALUE) VALUES (?, ?, ?)";
